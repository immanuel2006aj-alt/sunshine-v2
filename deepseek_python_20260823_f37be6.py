...
# --- CORS (allow all for now – we'll lock down later) ---
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# Global exception handler – ensures CORS headers on every error
...
# --- API Routes with try/except to catch all errors ---
@app.post("/signup")
...
# --- Bot polling in background thread (isolated, never crashes API) ---
def start_bot():
