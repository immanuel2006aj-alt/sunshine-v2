...
# CORS – allow all origins for debugging (lock down later)
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
...
# Manual OPTIONS handler for all routes (ensures preflight always gets CORS headers)
